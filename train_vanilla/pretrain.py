...
from models import DefaultTransformerForCausalLM, DefaultTransformerConfig
...
def main():
    ...
    ## if you want to use flash attention 2,you must implment flash attention2 model class.
    ...
    model = DefaultTransformerForCausalLM(config)
